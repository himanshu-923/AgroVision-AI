...
function getOpenAI(): OpenAI {
  ...
  if (!apiKey) {
    throw new Error("Missing OpenAI API key for audio features. Set AI_INTEGRATIONS_OPENAI_API_KEY or OPENAI_API_KEY.");
  }
...
export const openai = new Proxy({} as OpenAI, {
  get(_target, prop, receiver) {
    return Reflect.get(getOpenAI() as unknown as object, prop, receiver);
  },
});
